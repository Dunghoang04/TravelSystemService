        ...
        <div class="profile-form">
            ...
            <c:if test="${not empty sessionScope.loginUser}">
                <form action="${pageContext.request.contextPath}/ProfileUser" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" name="gender">
                                ...
                                <option value="Nam" ${sessionScope.loginUser.gender.toString().equalsIgnoreCase("Nam") ? 'selected' : ''}>Nam</option>
                                <option value="Nữ" ${sessionScope.loginUser.gender.toString().equalsIgnoreCase("Nữ") ? 'selected' : ''}>Nữ</option>
                                <option value="Khác" ${sessionScope.loginUser.gender.toString().equalsIgnoreCase("Khác") ? 'selected' : ''}>Khác</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <a href="${pageContext.request.contextPath}/ProfileUser?service=viewProfileUser" class="btn1">Quay lại</a>                </form>
                </c:if>
        </div>
    </body>
</html>
