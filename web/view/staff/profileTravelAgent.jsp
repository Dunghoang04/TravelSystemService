            ...
            <jsp:include page="../layout/sideNavOptionStaff.jsp"></jsp:include>  
                <div id="layoutSidenav_content">
                    <main>                        
                        ...
                        <c:if test="${requestScope.agent.status == 3}"><div style="color: red; font-size: 20px; text-align: center; margin-bottom: 20px">Lý do từ chối: ${requestScope.agent.reason}</div></c:if>
                            <div class="row">
                                <div class="col-md-6">
