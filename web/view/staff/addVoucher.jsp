                                    ...
                                    <form action="addvoucher" method="POST" >
                                        ...
                                        <div class="col-12 row time">
                                            <div class="col-6 ">
                                                ...
                                                <input type="text" name="voucherCode" class="form-control" placeholder="VD: WELCOME2025 (5-25 ký tự)" value="${param.voucherCode}" required/>
                                                <c:if test="${not empty voucherCodeErro}">
                                                    <div style="color:red">${voucherCodeErro}</div>
                                                </c:if>

                                            </div>
                                            <div class="col-6 ">
                                                <label class="form-label"><b>Tên thẻ</b> <span class="required" style="color:red">*</span></label>
                                                <input type="text" name="voucherName" class="form-control" placeholder="5-25 ký tự" value="${param.voucherName}" required/>
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Trên 10 ký tự..." rows="3">${param.description}</textarea>
                                        ...
                                        <div class="col-12 row form-group time">
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="number" name="quantity" class="form-control" placeholder="1-100" value="${param.quantity}" required/>
                                        ...
                                        <div class="col-12 row form-group time">
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="number" name="maxDiscountAmount" class="form-control" placeholder="Tối đa 100.000.000" value="${param.maxDiscountAmount}" step="1" required/>
                                            ...
                                            <div class="col-6 form-group time">
                                                ...
                                                <input type="number" name="minAmountApply" class="form-control" placeholder="Từ 0 đến 1.000.000.000" value="${param.minAmountApply}" step="1" required/>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="btn btn-info me-2" name="action" value="insert">Thêm khuyến mãi</button>
