 ...
 * 2025-07-03  1.0        Nguyen Huu Hung         First implementation
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Quản lí yêu cầu huỷ chuyến đi của đại lý</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main class="container mt-5">
                    <h2 class="mb-4">Quản lý yêu cầu huỷ chuyến đi của đại lý</h2>

                    <!-- Tìm kiếm + lọc -->
                    <div class="d-flex align-items-center mb-4 flex-wrap">
                        <!-- Tìm kiếm -->
                        <form action="travelagentmanagerequestcancel" method="get" class="d-flex align-items-center me-auto mb-2">
                        ...
                        <!-- Lọc trạng thái -->
                        <form action="travelagentmanagerequestcancel" method="get" class="d-flex align-items-center mb-2">
                        ...
                        <tbody>
                            <c:forEach var="r" items="${listRequest}" varStatus="loop">
                                ...
                                <tr>
                                    ...
                                    <td><fmt:formatNumber value="${r.bookDetail.totalPrice}" type="number" /> VNĐ</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <a href="travelagentrequestcanceldetail?id=${r.requestCancel.requestCancelID}" class="btn btn-sm btn-outline-primary">
                            ...
                            <ul class="pagination justify-content-center">
                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                                        <a class="page-link"
                                           href="travelagentmanagerequestcancel?page=${i}&keyword=${param.keyword}&status=${param.status}">
                                            ${i}
                                        </a>
                                    </li>
                                </c:forEach>
