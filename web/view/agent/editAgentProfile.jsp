            ...
            <div id="layoutSidenav_content">
                <main>                        
                    <div class="container-fluid px-4">
                        <form id="registerForm" action="${pageContext.request.contextPath}/ManageTravelAgentProfile" method="POST" class="row g-3 justify-content-center">
                            ...
                            <c:if test="${not empty requestScope.success}">
                                <div class="col-12">
                                    <h3 class="success">${requestScope.success}</h3>
                                </div>
                            </c:if>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <button class="button" type="submit" formaction="${pageContext.request.contextPath}/ManageTravelAgentProfile?service=viewProfile">Quay lại</button>
                                </div>
                                <div class="col-md-4">
