                    ...
                    <div class="container mt-5">
                        ...
                        <form action="addroom" method="POST">
                            <div class="col-12 form-group">
                                <label for="accommodationID"><b>Mã khách sạn</b></label>
                                <input type="text" class="form-control" id="accommodationID"readonly value="${requestScope.id}" name="accommodationID" required>
                            </div>
