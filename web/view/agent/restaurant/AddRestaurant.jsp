                                    ...
                                    <form action="addrestaurant" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <select name="type" id="type" class="selectpicker " data-live-search="false" data-width="100%" required>
                                                <option value="5 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'>5 sao</option>
                                                <option value="4 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'>4 sao</option>
                                                <option value="3 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'>3 sao</option>
                                            </select>
                                        </div>
