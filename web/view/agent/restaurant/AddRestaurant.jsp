                            ...
                            <div class="container mt-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <c:if test="${not empty requestScope.imageFileName}">
                                            <img id="previewImage" src="uploads/${requestScope.imageFileName}" alt="Ảnh nhà hàng" style="max-height: 100%; max-width: 100%; object-fit: contain;" />
                                        </c:if>
                                        <c:if test="${empty requestScope.imageFileName}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="addrestaurant" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <select name="type" id="type" class="selectpicker " data-live-search="false" data-width="100%" >
                                                <option value="5 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'${requestScope.type=="5 sao"?'selected':''}>5 sao</option>
                                                <option value="4 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'${requestScope.type=="4 sao"?'selected':''}>4 sao</option>
                                                <option value="3 sao" data-content='<i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>'${requestScope.type=="3 sao"?'selected':''}>3 sao</option>
                                            </select>
                                        </div>

                                        <div class="col-12 form-group">
                                            <select id="province" name="address" class="form-control" required oninvalid="this.setCustomValidity('Vui lòng chọn tỉnh/thành phố')"
