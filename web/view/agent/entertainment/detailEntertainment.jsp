...
<html>
    ...
    <style>
        ...
        main {
            ...
            position: relative;
            z-index: 0;
            background-image: url(./assets/img-entertainment/background-detail.jpg);
        ...
        main::before {
            ...
            width: 100%;
            height: 100%;
            background: rgba(0, 0, 0, 0.2); /* điều chỉnh độ tối ở đây */
            z-index: -1;
        }
        footer{
            margin-top: 0px;
                        ...
                        <div class="container mt-2">
                            ...
                            <div class="col-md-6 box-desc">
                                ...
                                <div class="col-12 rate">
                                    <h5>Loại hình : <span>${requestScope.entertainmentDetail.getType()}</span></h5>
                                </div>
