                                                ...
                                                <td class="box-button">
                                                    <div class="box-action">
                                                        <button type="button" class="btn btn-warning updatebtn" 
                                                                data-href="${pageContext.request.contextPath}/updateentertainment?id=${ent.getServiceId()}" data-name="${ent.getName()}">
                                                            Cập nhập
                                                        </button>
                                                        <button type="button" class="btn btn-primary detailbtn" 
                                                                data-href="${pageContext.request.contextPath}/detailentertainment?id=${ent.getServiceId()}" data-name="${ent.getName()}">
                                                            Chi tiết
                                                        </button>
                                                        <button type="button" class="btn btn-dark changeStatusBtn" 
                                                                data-href="${pageContext.request.contextPath}/ChangeStatus?id=${ent.getServiceId()}&page=${requestScope.currentPage}" 
