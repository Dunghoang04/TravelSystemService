...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Add Staff for TravelSystemService" />
                            ...
                            <div class="card-body">
                                ...
                                <form action="${pageContext.request.contextPath}/AddStaff" method="post">
                                    ...
                                    <div class="form-section">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control ${not empty employeeCodeError ? 'is-invalid' : ''}" id="employeeCode" name="employeeCode" value="${requestScope.employeeCode}" placeholder="VD: NV12345" />
                                                <c:if test="${not empty employeeCodeError}">
                                                    <div class="error-message">${employeeCodeError}</div>
                                                </c:if>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="hireDate" class="form-label">Ngày Tuyển Dụng</label>
                                                <input type="date" class="form-control ${not empty hireDateError ? 'is-invalid' : ''}" id="hireDate" name="hireDate" value="${requestScope.hireDate}" placeholder="Chọn ngày tuyển dụng" />
                                                <c:if test="${not empty hireDateError}">
                                                    <div class="error-message">${hireDateError}</div>
                                                </c:if>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" class="btn btn-submit">Thêm Nhân Viên</button>
                                    </div>
                                </form>
                            </div>
                        </div>
