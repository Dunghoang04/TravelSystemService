    ...
    <body>
        <header class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="text-primary m-0"></i>Du lịch Việt</h1>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="booking.html" class="nav-item nav-link">Đặt lịch</a>
                     <a href="testimonial.html" class="nav-item nav-link">Đánh giá</a>
                    
                    <a href="contact.html" class="nav-item nav-link">Liên hệ</a>
                </div>
                <a href="" class="btn btn-primary rounded-pill py-2 px-4">Đăng nhập</a>
            </div>
        </header>
    </body>
</html>
