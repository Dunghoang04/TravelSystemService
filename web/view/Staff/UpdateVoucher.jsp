        ...
        <div class="container mt-5">
            ...
            <form action="updatevoucher" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="percentDiscount" class="form-control" value="${voucher.percentDiscount}" step="0.01" required />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="maxDiscountAmount" class="form-control" value="${voucher.maxDiscountAmount}" step="0.01" required />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="minAmountApply" class="form-control" value="${voucher.minAmountApply}" step="0.01" required />
                </div>
                ...
                <div class="d-flex justify-content-center gap-3 mt-4 mb-5">
                    ...
                    <a href="voucherlist" class="btn btn-secondary px-4">Quay lại</a>
                </div>
            </form>
        </div>
    </body>
