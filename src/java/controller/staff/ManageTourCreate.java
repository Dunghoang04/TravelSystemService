...
public class ManageTourCreate extends HttpServlet {
    ...
    private void processSendConfirmationEmail(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int travelAgentID = tour.getTravelAgentID(); // Giả sử Tour có getTravelAgentID()
            ...
            try {
                EmailSender.send(email, "Xác nhận " + actionStatus + " tour - " + java.time.LocalDate.now(), body.toString());
