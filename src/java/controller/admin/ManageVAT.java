 ...
 * 2025-07-22  1.1        Hà Thị Duyên      Ensure endDate is not null, only latest VAT is active
 */
            ...
            if (!hasError) {
                try {
                    ...
                    LocalDate endDate = (endDateStr != null && !endDateStr.trim().isEmpty())
                            ...
                            : LocalDate.of(9999, 12, 31); // Giá trị mặc định nếu không nhập endDate
                    ...
                    request.setAttribute("successMessage", "Thêm VAT thành công!" + (status == 1 ? " Các VAT khác đã được ngừng hoạt động." : ""));
        ...
        if (statusStr == null || statusStr.trim().isEmpty()) {
            ...
            try {
                ...
                if (status != 0 && status != 1) {
                    request.setAttribute("statusError", "Trạng thái phải là 0 (Không hoạt động) hoặc 1 (Hoạt động).");
                    hasError = true;
                }
            } catch (NumberFormatException e) {
