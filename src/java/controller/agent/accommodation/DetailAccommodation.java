 ...
 */
@MultipartConfig
@WebServlet(name="DetailAccomodation", urlPatterns={"/DetailAccommodation"})
public class DetailAccommodation extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailAccomodation</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailAccomodation at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("rooms", rooms); // Sử dụng "rooms" thay vì "room"
